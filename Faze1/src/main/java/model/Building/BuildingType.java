...
public enum BuildingType {
    SMALL_STONE_GATEHOUSE("Small stone gatehouse", Gate.class, 1000, 0, null, 0, 0, 0, true, null, null),
    BIG_STONE_GATEHOUSE("big stone gatehouse", Gate.class, 2000, 0, ResourceType.STONE, 20, 0, 0,true, null, null),
    KEEP("keep", Tower.class, 0, 0, null, 0, 0,0, true, null, null),
    DRAWBRIDGE("drawbridge", Gate.class, 0,0, ResourceType.WOOD, 10, 0,0, true, null, null),
    LOOKOUT_TOWER("lookout tower", Tower.class, 1300, 0, ResourceType.STONE, 10, 0, 0, true, null, null),
    PERIMETER_TOWER("perimeter tower", Tower.class, 1000, 0 , ResourceType.STONE, 10, 0 ,0, true, null, null),
    DEFENCE_TURRET("defence turret", Tower.class, 1200, 0, ResourceType.STONE, 15, 0 ,  0, true, null, null),
    SQUARE_TOWER("square tower", Tower.class, 1600, 0, ResourceType.STONE, 35, 0 , 0, true, null, null),
    CIRCLE_TOWER("circle tower", Tower.class,  2000, 0, ResourceType.STONE, 40, 0,  0, true, null, null),
    ARMOURY("armoury", Storage.class,500, 0, ResourceType.WOOD, 5, 0,0, true, null, null),
    BARRACK("barrack", UnitCreation.class, 500, 0, ResourceType.STONE, 15, 0,0, true, null, null),
    MERCENARY_POST("mercenary post", UnitCreation.class, 500, 0, ResourceType.WOOD, 10, 0,0, true, null, null),
    ENGINEER_GUILD("engineer guild", Building.class, 500, 100, ResourceType.WOOD, 10, 0,0, true, null, null),
    KILLING_PIT("killing pit", Traps.class, 0, 0, ResourceType.WOOD, 6, 0 ,0,true, null, null),
    //todo abjoo
    INN("inn", ProductionCenter.class,300, 100, ResourceType.WOOD, 20, 1, 0, false, new Resources(ResourceType.ALE, 1), null),
    MILL("mill", ProductionCenter.class, 300, 0, ResourceType.WOOD, 20, 3, 0, false, new Resources(ResourceType.WHEAT, 2), new Resources(ResourceType.FLOUR, 1)),
    IRON_MINE("iron mine", ProductionCenter.class, 100, 0, ResourceType.WOOD, 20, 2, 0,false, null, new Resources(ResourceType.IRON, 10)),
    MARKET("market", Building.class, 300, 0, ResourceType.WOOD, 5, 1, 0, false, null, null),
    OX_TETHER("ox tether", ProductionCenter.class, 100, 0, ResourceType.WOOD, 5, 1, 0, false, null, null), // AFSAR GAV
    PITCH_RIG("pitch rig", ProductionCenter.class, 100, 0, ResourceType.WOOD, 20, 1, 0,false, null, new Resources(ResourceType.PITCH, 3)),
    QUARRY("quarry", ProductionCenter.class, 300, 0, ResourceType.WOOD, 20, 3, 0, false, null, new Resources(ResourceType.STONE, 10)),
    STOCKPILE("stockpile", Storage.class, 500, 0, null, 0, 0, 0, false, null, null),
    WOODCUTTER("woodcutter", ProductionCenter.class,100, 0, ResourceType.WOOD, 3,  1, 0, false, null, new Resources(ResourceType.WOOD, 10)),
    //todo any idea about unemployed human maybe resource
    HOVEL("hovel", UnitCreation.class, 100, 0, ResourceType.WOOD, 6, 0 ,0, false, null, null),
    CHURCH("church", UnitCreation.class, 800, 250, null, 0, 0, 0, false, null, null),
    CATHEDRAL("cathedral", UnitCreation.class,1200, 1000, null, 0,0,0, false, null, null),
    ARMOURER("armourer", ProductionCenter.class,300, 100, ResourceType.WOOD, 20, 1, 0, false, new Resources(ResourceType.IRON, 6), new DefensiveWeapon(DefenseType.METAL_ARMOR, 1)),
    //todo : what about blackSmith?
    BLACKSMITH("blacksmith", ProductionCenter.class, 300, 100, ResourceType.WOOD, 20, 1, 0, false, new Resources(ResourceType.IRON, 6), null),
    FLETCHER( "fletcher",ProductionCenter.class, 300, 100, ResourceType.WOOD, 20, 1, 0, false, new Resources(ResourceType.WOOD, 6), new Weapon(WeaponType.BOW, 1)),
    //todo: again?
    POLE_TURNER("pole_turner",  ProductionCenter.class, 300, 100, ResourceType.WOOD, 10, 1, 0,false, new Resources(ResourceType.IRON, 6), null),
    OIL_SMELTER("oil smelter", ProductionCenter.class,300, 100, ResourceType.STONE, 10, 0, 1, true, null, new Weapon(WeaponType.PETROLEUM, 5)),
    PITCH_DITCH("pitch ditch", Traps.class, 300, 0, ResourceType.PITCH, 2, 0, 0, true, null, null),
    CAGED_WAR_DOGES("caged war dogs", Traps.class, 100, 100, ResourceType.WOOD, 10, 0, 0, true, null, null),
    SIEGE_TENT("siege tent", Building.class, 100, 0, null, 0, 0, 1, true, null, null),
    //todo: think about this
    STABLE("stable", ProductionCenter.class, 300,400, ResourceType.WOOD, 20, 0, 0, true, null, null),
    APPLE_GARDEN("apple garden", ProductionCenter.class, 100, 0, ResourceType.WOOD, 5, 1,0, false, null, new Food(FoodType.APPLES, 5)),
    DAIRY_PRODUCTS("dairy products", ProductionCenter.class, 100, 0, ResourceType.WOOD, 10, 1, 0, false, null, new Food(FoodType.CHEESE, 5)),
